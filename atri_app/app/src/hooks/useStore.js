...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "TextBox132": {
      "custom": {
        "text": "How to build rapport with your web design clientss, that cover everything you need"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox91": {
      "custom": {
        "text": "The best metrics are customer adoption, happiness, task success, and engagement. "
      },
      "callbacks": {
        "onClick": [
          {
